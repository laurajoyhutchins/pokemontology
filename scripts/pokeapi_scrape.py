...
The defaults are chosen to align with PokeAPI's published fair-use guidance:
...
def detail_cache_path(cache_dir: Path, resource: str, name: str) -> Path:
    return cache_dir / resource / "detail" / f"{sanitize_segment(name)}.json"
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Stop after this many list pages.",
    )
    parser.add_argument(
        "--max-details",
        type=int,
