...
def test_query_engine_uses_comunica_fallback_urls() -> None:
    ...
    assert "rdf.js.org/comunica-browser/versions/v4/engines/query-sparql/comunica-browser.js" in text
    assert "cdn.jsdelivr.net/npm/@comunica/query-sparql@3/pkg/comunica-browser.js" in text
